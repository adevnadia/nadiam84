...
app.controller('SampleController', ['$scope', '$timeout', function ($scope, $timeout) {
    ...
    $scope.model.people = [
        ...
        {id: 4, name: "Becc Roach", team: "Senior UX Designer", photo: "static/images/avatars/becc.jpg"},
        {id: 5, name: "Andrew McKay", team: "Designer", photo: "static/images/avatars/andrew.jpeg"},
        {id: 33, name: "Becky Todd", team: "Senior Technical Writer", photo: "static/images/avatars/becky.png"},
